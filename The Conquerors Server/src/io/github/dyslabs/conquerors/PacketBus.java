...
public class PacketBus {
	 ...
	 * 
	 * @param pid
	 * @param fields format of fieldName(String),value(T)
	 * @return
	 ...
	 */
	public static Packet craftPacket(int pid,Object... fields) throws NoSuchMethodException, SecurityException, InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchFieldException {
		Class<?> clazz;
		try {
